...
const WelcomeCard = (items) => {
    const {id, title, description, img} = items.items;

  return (
    <div key={id+title} className="flex flex-col items-center justify-center mx-auto w-[250px] h-[250px] max-w-[600px] max-h-[600px] sm:w-[380px] sm:h-[380px] lg:w-[320px] lg:h-[320px] 2xl:w-[450px] 2xl:h-[450px] aspect-square bg-blue-100 rounded-md shadow-md p-4">
